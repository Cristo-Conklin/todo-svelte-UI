...
<main>
  <div class="container">
    <h1 class="my-3 display-6 text-warning text-center fst-italic">vNotes</h1>
    <h6 class="my-1 display-8 text-warning text-center fst-italic">
      ToDo's List w Extended feats
    </h6>
